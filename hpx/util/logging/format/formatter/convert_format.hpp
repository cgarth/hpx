...
namespace convert {
    ...
    */
    namespace prepend {
        ...
        class p6, class p7, class p8, class p9, class p10> void write(const std::string
            & src, ::hpx::util::logging::tag::holder<string_,p1,p2,p3,p4,p5,p6,p7,p8,
            p9,p10> & dest) {
            typedef typename use_default<string_, std::string>::type string;
        ...
        template<class string_, class p1, class p2, class p3, class p4, class p5,
        class p6, class p7, class p8, class p9, class p10> void write(const char* src,
